...
GO
/****** Object:  StoredProcedure [dbo].[CheckOrders_WG_V1]    Script Date: 21.02.2023 15:50:27 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[CheckOrders_WG_V1]
	@branch varchar(100)
	,@date1 datetime
	,@date2 datetime
	,@status varchar(50)
...
,isnull(iif(bd.osp like '______' and bd.osp like '%[0-9]%',(select mainpostoffice from monitoring.dbo.vpostsprav where postcode = bd.osp), 'ОСП'), '') as MainPostOffice
,OrderNumber
,bd.osp
,bd.Account
